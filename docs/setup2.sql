...
create table items (
	...
	likes text,
	index itemFeedUrl (feedUrl),
	index itemPubDate (pubDate),
	index feedItemIndex (flDeleted, pubDate, feedUrl),
	index itemGuidUrl (guid, feedUrl),
	index itemDeleted (flDeleted),
	index feedId (feedId)
	);
...
create table subscriptions (
	...
	index subscriptionsListname (listname),
	index subscriptionsFeedUrl (feedUrl),
	index feedId (feedId)
	);
